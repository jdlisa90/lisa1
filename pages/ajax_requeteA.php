...
if($comp<>""){
    $sql.=" and (individus.civilite LIKE :comp OR individus.surnom LIKE :comp)";
}
if($div<>""){
...
$result="<div class='row mt-3 pb-3' style='border-bottom:none;'><div class='col pe-0'>
    <p><a href='#' data-bs-toggle='modal' data-bs-target='#archives' title='Éditer la recherche'><b>Recherche par archives</b></a> : 
    <a href='accueil1-sources_archive-arch-".$l["id"].".html' title='Page de l&#39;archive'>$lib_arch ".$l["libarch"]."</a> ; ".$situation." ; ".$result.$incomplet."</p>"; // ligne de résumé de la recherche 
$sql.=" AND individus.arch=:arch AND individus.m_e_lCNIL<=".date("Y");
...
if($comp<>"") $rek->bindValue('comp', "%".$comp."%", PDO::PARAM_STR);
...
if ($nb_rep>0){
    ...
    while ($l=$id_rk->fetch(PDO::FETCH_ASSOC)){
        ...
        $result.="<td class='pb-0 pt-0'>".$l["prenom"]."<td class='pb-0 pt-0'>".$lieu_aff."<td class='pb-0 pt-0'>".$an."<td class='pb-0 pt-0'>".$l["type_acte"]."<td class='pb-0 pt-0'>".$l["situation"];
        $result.="</tr>";
        $nbl++;
    }
    $result.="</tbody>
    ...
    if($nb_page_total>1){
        ...
        $page1=$page+1;
        if ($page>0){
            $result.="&nbsp;&nbsp;&nbsp;&nbsp;<a href='#' onClick='requeteA(0)' title='Première'><b><<</b></a>
            &nbsp;&nbsp;<a href='#' onClick='requeteA($page0)' title='Précédente'><b><</b></a>";
        }
        $result.=" &nbsp; <select name='p' id='select_page' onChange='requeteA(\"\select\")'>";
        ...
        if($page<$nb_page_total-1){
            $result.="&nbsp;&nbsp;<a href='#' onClick='requeteA($page1)' title='Suivante'><b>></b></a>
            &nbsp;&nbsp;<a href='#' onClick='requeteA($nb_page_total-1)' title='Fin'><b>>></b></a>";
        }
    }
    $result.="</div></div>";
}
